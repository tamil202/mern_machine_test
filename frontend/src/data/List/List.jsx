  ...
  return (
    <>
      {isSHow2 && (
        <section>
          <div className="container mx-auto ">
            ...
            <div>
              <table className="w-full relative border-collapse border border-gray-200">
                <thead>
                ...
                <tbody>
                  {!data && (
                    <div className="absolute  left-[49%] top-full">
      ...
      <div className="z-50  left-[40%] top-2 ">
        {isSHow3 && (
          <Update value={value} setShow2={setShow2} setShow3={setShow3} />
        )}
      </div>
      <ToastContainer />
      <div className="z-50  left-[40%] top-2 ">
        {isSHow && <CreateList setShow={setShow} setShow2={setShow2} />}
      </div>
    </>
  );
};
